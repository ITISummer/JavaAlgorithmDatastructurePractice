...
/*
标题：扑克序列 AA223344，一共4对扑克牌。请你把它们排成一行。
要求：两个A中间有1张牌，两个2之间有2张牌，两个3之问有3张牌，两个4之间有4张牌
请填写出所有符合要求的排列中，字典序最小的那个
例如：22A43344比A2A23344字典序小。当然，它们部不是满足要求的答案。
请通过浏览器提交答案。“A”一定不要用小写字母a，也不要用“1”"代替。字符闾一定不要留空格
 */
public class _07_扑克排序 {
     ...
     * @param k
     */
    private static void res(char[] a, int k) {
        if (k == a.length) {
